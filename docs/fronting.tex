...
Pricing is accurate as of February~2015.
A ``no'' in the ``allows SNI$\ne$Host'' means that the service requires the ``domainless'' fronting style.
}
\label{tab:survey}
...
\hline
Google App Engine\tnote{1} &        0.120 &              -- &    0.05 &       -- & yes \\
Amazon CloudFront          & 0.085--0.250 &    0.010--0.022 &      -- &       -- & yes \\
Microsoft Azure            & 0.087--0.138 &              -- &      -- &       -- & yes \\
CloudFlare                 &           -- &              -- &      -- &      200 & yes \\
Fastly\tnote{2}            & 0.120--0.190 &    0.010--0.012 &      -- &       -- & no  \\
Akamai\tnote{3}            &           -- &              -- &      -- &      400 & yes \\
Level~3\tnote{4}           & 0.035--0.200 &              -- &      -- &       -- & no  \\
% EdgeCast
\noalign{\smallskip}
\end{tabular}
...
\item[2] Fastly has a minimum monthly charge of \$50.
...
% http://cachesimple.com/get.php?p=plans
...
% \textbf{EdgeCast}~\cite{edgecast}
% GFW blocking of edgecast.net.
...
% https://lists.torproject.org/pipermail/tor-dev/2015-February/008239.html
