...
obtain a 10-minute sample of normal HTTPS traffic trace from LBL. The trace is 983~megabytes in total. 
...
% Censors that know no bounds: China on Google, Egypt.
