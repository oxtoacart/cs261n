...
\x16\x03\x01\x02\x00\x01\x00\x01\xfc\x03\x03\x9b\xa9\x9f\xf5\xbb
...
\end{verbatim}
\begin{quote}
\begin{verbatim}
...
\x16\x03\x03\x00\x3e\x02\x00\x00\x3a\x03\x03\x53\x75\xa2\x78\x7d
...
\end{verbatim}
\end{quote}
\begin{verbatim}
...
\x14\x03\x03\x00\x01\x01\x16\x03\x03\x00\x40\x06\x84\x25\x72\x1e
...
\end{verbatim}
\end{quote}
\caption{
...
is the beginning of a TLS handshake).
...
% out of order, blah blah.
% "concatenates successive bodies"
% handle it by strict serialization, has performance issues, see ...
