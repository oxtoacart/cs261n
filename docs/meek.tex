...
It is thus the only service we have found
for which the ``domainless'' fronting style is required.
...
% 0.405263438 0.376721457 0.071558122 0.019904635 0.018484229 0.014867466
%         811         783         151        1263
% 0.012312158 0.007811639 0.007030949 0.006568932
\begin{table}[h]
\normalsize
\centering
\begin{tabular}{r r >{\qquad} r r}
\multicolumn{2}{c}{LBL Google HTTPS} & \multicolumn{2}{>{\qquad}c}{meek on App Engine} \\
0 bytes & 37.7\% & 1418 bytes & 40.5\% \\
1430 bytes & 9.1\% & 0 bytes & 37.8\% \\
1418 bytes & 8.5\% & 1460 bytes & 7.2\% \\
41 bytes & 6.1\% & 396 bytes & 2.0\% \\
1416 bytes & 3.1\% & 196 bytes & 1.8\% \\
1460 bytes & 3.0\% & 1024 bytes & 1.5\%
\end{tabular}
...
\caption{CDF of connection lifetime.}
\label{fig:duration}
\end{figure}

\subsection{Connection lifetime}
We consider the connection lifetime as a potential weakness. Figure~\ref{fig:duration} shows the 
...
consistent with the discussions above. Second, the durations are much longer if we notice the x-axis in Figure~\ref{fig:duration}. If there is not a case in which normal users also have such long connections when browsing Google, the 
