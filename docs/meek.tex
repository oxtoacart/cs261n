...
Figure~\ref{fig:wire-sequential} shows the current implementation,
and Figure~\ref{fig:wire-parallel} shows the nature of performance
...
\caption{
Concurrent users of \meek\ with Tor.
}
\label{fig:clients}
\end{figure}
