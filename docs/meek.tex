...
These browser techniques improve performance, but may also lead to unexpected consequences. 
...
Additionally, the persistent connection itself can be a problem.
