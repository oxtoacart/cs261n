...
Figure~\ref{fig:protocol} shows an sample of the protocol.
...
The protocol shown here is encrypted inside HTTPS until after
it has been fronted,
so the censor is unable to classify the traffic based on the
Host or X-Session-ID headers.
}
\label{fig:protocol}
\end{figure}
