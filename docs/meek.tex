...
We implemented two versions of a browser extension, one for Firefox and one for Chrome.
They both work similarly: they open a TCP port on localhost,
...
Rather than starting \meekclient\ directly, the tor
...
We can include a small extension in the browser bundle and reuse the existing
