...
qplot(lbl$datalen, geom="histogram", main="TCP payload length", binwidth=5) + xlab("length")  

dev.off()

png("diagrams/datalen-in.png")
qplot(lbl[lbl$dir=="IN",]$datalen, main="TCP payload length (incoming)", binwidth=5) + xlab("length") 
dev.off()

png("diagrams/datalen-out.png")
qplot(lbl[lbl$dir=="OUT",]$datalen, main="TCP payload length (outgoing)", binwidth=5) + xlab("length") 
dev.off()

png("diagrams/datalen-google.png")
qplot(lbl[lbl$google,]$datalen, main="TCP payload length (Google only)", binwidth=5) + xlab("length") 
dev.off()
...
qplot(lbl[lbl$google & lbl$dir=="IN",]$datalen, main="TCP payload length (incoming, Google only)", binwidth=5) + xlab("length") 
dev.off()

png("diagrams/datalen-google-out.png")
qplot(lbl[lbl$google & lbl$dir=="OUT",]$datalen, main="TCP payload length (outgoing, Google only)", binwidth=5) + xlab("length") 
dev.off()

png("diagrams/datalen-tbb.png")
qplot(x[x$source=="tbb",]$datalen, main="TCP payload length (TBB meek)", binwidth=5) + xlab("Length") 
dev.off()
...
qplot(intervals, geom="histogram", main="Interval between SYNs", binwidth=5) + xlab("time elapsed between SYNs") 
dev.off()
...
qplot(intervals, geom="histogram", main="Interval between SYNs (Google only)", binwidth=5) + xlab("time elapsed between SYNs") 
dev.off()
